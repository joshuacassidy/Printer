...
public class Main {
    public static void main(String[] args){
        ...
        for(int i =0; i < random.nextInt(15)+1;i++){
            ...
            print(printer,random.nextInt(1000)+1,random.nextInt(20)+1,random.nextInt(500)+1);
        }
    }

    public static void print(Printer printer,int jobNumber,int pages,int printerId){
